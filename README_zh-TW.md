...
| # | 作品 | 簡述 |
|---|---|---|
| 1 | **FactorHammer** | 台股／美股量化研究與回測工具，本機離線執行、不做實單交易。 |
| 2 | **Warboard Theater 戰局劇場** | 瀏覽器中的 3D 歷史戰役推演劇場，以時間軸與自動導播重現經典戰役。 |
| 3 | **After The Model** | 設定在 2030 年的 2D 橫向賽博龐克探索遊戲；扮演 AI 重塑後城市裡的底層小人物。 |
| 4 | **Sparkote** | 由現實任務驅動的療癒探索遊戲——把照顧自己的小事化為能量，驅動郵差在迷霧群島間探索送信。 |
